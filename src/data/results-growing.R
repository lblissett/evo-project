mydata5 = read.csv("/home/*/IdeaProjects/evo-project/src/data/results_n5_isGrowing_true.csv", header=TRUE)
mydata20 = read.csv("/home/*/IdeaProjects/evo-project/src/data/results_20_isGrowing_true.csv", header=TRUE)
mydata50 = read.csv("/home/*/IdeaProjects/evo-project/src/data/results_n50_isGrowing_true.csv", header=TRUE)
library(ggplot2)
limitsX = c(0, 1500)
limitsY = c(0, 75)
