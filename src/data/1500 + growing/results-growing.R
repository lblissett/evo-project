mydata5 = read.csv("/home/*/IdeaProjects/evo-project/src/data/1500 + growing/results-gene-5.csv", header=TRUE)
mydata20 = read.csv("/home/*/IdeaProjects/evo-project/src/data/1500 + growing/results-gene-20.csv", header=TRUE)
mydata50 = read.csv("/home/*/IdeaProjects/evo-project/src/data/1500 + growing/results-gene-50.csv", header=TRUE)
library(ggplot2)
limitsX = c(0, 1500)
limitsY = c(0, 75)
...
g5 + theme() + theme(panel.grid.major = element_line(color = "black", linetype = "dotted"), legend.position = "right") + labs(x = "Zyklus",y = "Fitnesswert", title = "Fitnessverlauf mit 5 Genen")
...
g20 + theme() + theme(panel.grid.major = element_line(color = "black", linetype = "dotted"), legend.position = "right") + labs(x = "Zyklus",y = "Fitnesswert", title = "Fitnessverlauf mit 20 Genen")
...
g50 + theme() + theme(panel.grid.major = element_line(color = "black", linetype = "dotted"), legend.position = "right") + labs(x = "Zyklus",y = "Fitnesswert", title = "Fitnessverlauf mit 50 Genen")
